...
export const metadata: Metadata = {
	...
	authors: [{ name: SITE_NAME, url: MAIN_SITE_URL }],
	creator: SITE_NAME,
	publisher: SITE_NAME,
...
const manrope = Manrope({
	// TODO: сайт русскоязычный, но кириллический subset не подключён — весь
	// русский текст отрисовывается системным шрифтом, а не Manrope.
	// Добавление 'cyrillic' это исправит, но заметно изменит типографику.
	subsets: ['latin'],
